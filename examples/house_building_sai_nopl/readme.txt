...
* Before running: copy the files antlr-runtime-4.7.jar and sai.jar to the JACAMO_HOME directory. Such file is available in the /build/libs directory of the sai package.
